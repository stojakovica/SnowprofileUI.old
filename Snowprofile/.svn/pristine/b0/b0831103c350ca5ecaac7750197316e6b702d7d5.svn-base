Ext.define('LWD.model.snowprofile.SnowProfileMeasurements', {
    ...
    associations: [
       {type: 'hasOne', model: 'LWD.model.snowprofile.airTempPres', name: 'airTempPres', associationKey:'airTempPres', getterName: 'getAirTempPres'},
       ...
       {type: 'hasOne', model: 'LWD.model.snowprofile.contentUomModel', name: 'penetrationSki', associationKey:'penetrationSki'},
       {type: 'hasOne', model: 'LWD.model.snowprofile.profileDepth', name: 'profileDepth', associationKey:'profileDepth', getterName: 'getProfileDepth'},
       ...
       {type: 'hasOne', model: 'LWD.model.snowprofile.windSpd', name: 'windSpd', associationKey:'windSpd', getterName: 'getWindSpd'}
    ],
